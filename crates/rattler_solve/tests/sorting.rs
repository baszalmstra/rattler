...
use rattler_solve::{ChannelPriority, SolveStrategy, resolvo::{CondaDependencyProvider, NameType}};
...
fn create_sorting_snapshot(package_name: &str, strategy: SolveStrategy) -> String {
    ...
    let name = dependency_provider.pool.intern_package_name(NameType::from(&package_name));
