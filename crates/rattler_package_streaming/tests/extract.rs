...
mod remote {
    ...
    const DATA_DESCRIPTOR_PACKAGE: &str =
        "tests/resources/ca-certificates-2024.7.4-hbcca054_0.conda";
    ...
    async fn test_extract_slow_remote_tar_bz2() {
        ...
        let expected_sha256 =
            rattler_digest::compute_bytes_digest::<rattler_digest::Sha256>(&bz2_data);
